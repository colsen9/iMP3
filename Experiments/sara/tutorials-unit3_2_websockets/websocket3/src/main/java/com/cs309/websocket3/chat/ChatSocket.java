...
public class ChatSocket {
   ...
   * easiest.
    ...
    // broadcast that new user joined
		String message = "[" + timeNow() + "] " + "Welcome, " + username + "!";
		broadcast(message);
	}
    ...
    // Direct message to a user using the format "@username <message>"
      ...
      // send the message to the sender and receiver
			sendMessageToParticularUser(destUsername, ts +  "[DM] " + username + ": " + message);
			sendMessageToParticularUser(username, ts + "[DM] " + username + ": " + message);

		} 
    else { // broadcast
			broadcast(ts + username + ": " + message);
		}
    ...
    // broadcase that the user disconnected
		String message = "[" + timeNow() + "] " + username + " has logged off. Chat feels emptier now :(.";
		broadcast(message);
	}
